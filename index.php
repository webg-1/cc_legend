...
<body onload="ccgen();  onLoadChks();"style="background: <?php echo $theme_background ?>;">
	<div class="container" id="container">
		...
		<div class="row justify-content-md-center">
			<div class="col-md">
				<center>
					<img class="rounded-circle" src="./assets/img/icon.jpg" width="200" height="200" style="margin-top: 40px;">
				</center>
			</div>
		</div>
		<!-- END OF IMAGE HEADER -->
		...
		<div class="footer" id="footer"><center><p style="color: <?php echo $theme_text ?>"><p>Legend CC Checker</p><p hidden>Tikol4Life</p></center></div>
	</div>
